...
# Install Spark 1.6.0
RUN cd /opt && wget http://dist.apache.org/repos/dist/release/spark/spark-2.0.0-preview/spark-2.0.0-preview-bin-hadoop2.7.tgz && tar xzvf spark-2.0.0-preview-bin-hadoop2.7.tgz
